class CalendarController < ApplicationController
  ...
  def workorders
    ...
    event_table.css('tr').each do |r|
      ...
      e['room_setup_notes'] = r.css('.views-field-field-lc-room-setup-notes').text.strip
  ...
  def login(username, password)
    agent = Mechanize.new
    agent.get('https://live-traversearea.pantheonsite.io/user/login')
