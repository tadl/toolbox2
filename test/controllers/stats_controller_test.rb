...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post stats_url, params: { stat: { code: @stat.code, end_date: @stat.end_date, group_name: @stat.group_name, name: @stat.name, start_date: @stat.start_date } }
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { code: @stat.code, end_date: @stat.end_date, group_name: @stat.group_name, name: @stat.name, start_date: @stat.start_date } }
